...
echo 5 4.8 15 $strike $dip $rake 5 0 0 $evname:  $strike/$dip/$rake BHE | gmt psmeca -J${projection} -R${bounds} -Bf5 -Bwsne -Sa14c/20 -G128/128/128 -Fa0.6c/cc -O -K -V >> ${epsfile}
